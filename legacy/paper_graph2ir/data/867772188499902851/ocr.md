...
### REFERENCES
[1] M. Andriushchenko and N. Flammarion, "Understanding and improving fast adversarial training," arXiv preprint arXiv:2007.02617, 2020.
[2] Anonymous, "Lottery tickets can have structural sparsity," in Submitted to The Tenth International Conference on Learning Representations, 2022, under review. [Online]. Available: https://openreview.net/forum?id=oZe7Zdia1H5
[3] S. Bak, C. Liu, and T. Johnson, "The second inter- national verification of neural networks competition (vnn-comp 2021): Summary and results," arXiv preprint arXiv:2109.00498, 2021.
...
![](./images/867772188499902851_19.jpg)

Fig. 9: Comparison of finetuning and weight-rewinding verified accuracy v.s. pruning times under auto-LiRPA setting.
...
![](./images/867772188499902851_20.jpg)

Fig. 10: Verified accuracy v.s. iterative pruning times under different random seeds with auto-LiRPA training. (a) is IMP pruning and (b) is IMP+NRSLoss pruning.

[5] K. Dvijotham, R. Stanforth, S. Gowal, T. A. Mann, and P. Kohli, “A dual approach to scalable verification of deep networks.” in UAI, vol. 1, no. 2, 2018, p. 3.

[6] R. Ehlers, “Formal verification of piece-wise linear feed-

TABLE V: Comparison of verified accuracy of different incomplete verification and complete verification methods for models trained with auto-LiRPA and pruned with several representative pruning methods on CIFAR10.

|          | IBP  | CROWN | $\beta$-CROWN |      |
|----------|------|-------|---------------|------|
|          |      |       | AVG.          | BEST |
| IMP      | 47.2 | 43.6  | 50.1          | 50.3 |
| HYDRA    | 46.8 | 43.1  | 48.3          | 49.3 |
| IMP+RS   | 47.5 | 42.1  | 46.3          | 48.6 |
| IMP+NRS  | 47.3 | 43.4  | 51.2          | 51.8 |
| SLIM     | 46.0 | 41.9  | 47.5          | 47.8 |

TABLE VI: The verified accuracies under different sparsities of our reproduced CROWN-IBP experiments on SVHN dataset from [29]. The verified accuracy is obtained using CROWN-IBP. The model is CNN-large as in [29].

| REMAIN RATIO | LWM   | HYDRA |
|--------------|-------|-------|
| 1            | 48.99 |       |
| 0.1          | 49.48 | 48.60 |
| 0.05         | 45.56 | 44.18 |
...
forward neural networks," in *International Symposium on Automated Technology for Verification and Analysis*. Springer, 2017, pp. 269-286.

[7] U. Evci, "Detecting dead weights and units in neural networks," *arXiv preprint arXiv:1806.06068*, 2018.
...
[9] Y. Fu, Q. Yu, Y. Zhang, S. Wu, X. Ouyang, D. D. Cox, and Y. Lin, "Drawing robust scratch tickets: Subnetworks with inborn robustness are found within randomly ini- tialized networks," in *Thirty-Fifth Conference on Neural Information Processing Systems*, 2021.
...
[11] S. Gui, H. N. Wang, H. Yang, C. Yu, Z. Wang, and J. Liu, "Model compression with adversarial robustness: A unified optimization framework," *Advances in Neural Information Processing Systems*, vol. 32, pp. 1285-1296, 2019.

[12] H. Han, K. Xu, X. Hu, X. Chen, L. Liang, Z. Du, Q. Guo, Y. Wang, and Y. Chen, "Scalecert: Scalable certified defense against adversarial patches with sparse superficial layers," *Advances in Neural Information Processing Systems*, vol. 34, 2021.

[13] T.-K. Hu, T. Chen, H. Wang, and Z. Wang, "Triple wins: Boosting accuracy, robustness and efficiency together by enabling input-adaptive inference," in *International Conference on Learning Representations*, 2020.

[14] S. Ioffe and C. Szegedy, "Batch normalization: Accelerat- ing deep network training by reducing internal covariate shift," in *International conference on machine learning*. PMLR, 2015, pp. 448-456.

[15] A. Jordao and H. Pedrini, "On the effect of pruning on adversarial robustness," in *Proceedings of the IEEE/CVF International Conference on Computer Vision*, 2021, pp. 1-11.

[16] G. Katz, C. Barrett, D. L. Dill, K. Julian, and M. J. Kochenderfer, "Reluplex: An efficient smt solver for veri- fying deep neural networks," in *International Conference on Computer Aided Verification*. Springer, 2017, pp. 97-117.

[17] A. Krizhevsky, G. Hinton *et al.*, "Learning multiple layers of features from tiny images," 2009.

[18] M. Kurt. (2020, Aug.) What is pruning in machine learning? [Online]. Available: https://opendatascience.com/what-is-pruning-in-machine-learning/
...
[21] Z. Liu, J. Li, Z. Shen, G. Huang, S. Yan, and C. Zhang, "Learning efficient convolutional networks through net- work slimming," in *Proceedings of the IEEE international conference on computer vision*, 2017, pp. 2736-2744.
...
[23] X. Ma, F.-M. Guo, W. Niu, X. Lin, J. Tang, K. Ma, B. Ren, and Y. Wang, "Pconv: The missing but desirable sparsity in dnn weight pruning for real-time execution on mobile devices," in *Proceedings of the AAAI Conference on Artificial Intelligence*, vol. 34, no. 04, 2020, pp. 5117-5124.

[24] M. N. Müller, G. Makarchuk, G. Singh, M. Püschel, and M. Vechev, "Prima: Precise and general neural network certification via multi-neuron convex relaxations," *arXiv preprint arXiv:2103.03638*, 2021.
...
[26] A. Raghunathan, J. Steinhardt, and P. Liang, "Certified defenses against adversarial examples," *arXiv preprint arXiv:1801.09344*, 2018.

[27] S. Roy, P. Panda, G. Srinivasan, and A. Raghunathan, "Pruning filters while training for efficiently optimizing deep learning networks," in *2020 International Joint Conference on Neural Networks (IJCNN)*. IEEE, 2020, pp. 1-7.

[28] H. Salman, G. Yang, H. Zhang, C.-J. Hsieh, and P. Zhang, "A convex relaxation barrier to tight robustness verification of neural networks," *Advances in Neural Information Processing Systems*, vol. 32, 2019.

[29] V. Sehwag, S. Wang, P. Mittal, and S. Jana, "Hydra: Pruning adversarially robust neural networks," *arXiv preprint arXiv:2002.10509*, 2020.

[30] Z. Shi, Y. Wang, H. Zhang, J. Yi, and C.-J. Hsieh, "Fast certified robust training with short warmup," *Advances in Neural Information Processing Systems*, vol. 34, 2021.

[31] G. Singh, T. Gehr, M. Püschel, and M. Vechev, "An ab- stract domain for certifying neural networks," *Proceedings of the ACM on Programming Languages*, vol. 3, no. POPL, pp. 1-30, 2019.
...
[33] C. Tjandraatmadja, R. Anderson, J. Huchette, W. Ma, K. K. PATEL, and J. P. Vielma, "The convex relaxation barrier, revisited: Tightened single-neuron relaxations for neural network verification," *Advances in Neural Information Processing Systems*, vol. 33, pp. 21 675-21 686, 2020.
...
[35] S. Wang, H. Zhang, K. Xu, X. Lin, S. Jana, C.-J. Hsieh, and J. Z. Kolter, "Beta-crown: Efficient bound propaga- tion with per-neuron split constraints for complete and incomplete neural network verification," *arXiv preprint arXiv:2103.06624*, 2021.

[36] X. Wang, F. Yu, Z.-Y. Dou, T. Darrell, and J. E. Gonzalez, "Skipnet: Learning dynamic routing in convolutional networks," in *Proceedings of the European Conference on Computer Vision (ECCV)*, 2018, pp. 409-424.

[37] L. Weng, H. Zhang, H. Chen, Z. Song, C.-J. Hsieh, L. Daniel, D. Boning, and I. Dhillon, "Towards fast computation of certified robustness for relu networks," in *International Conference on Machine Learning*. PMLR, 2018, pp. 5276-5285.

[38] E. Wong and Z. Kolter, "Provable defenses against adversarial examples via the convex outer adversarial polytope," in *International Conference on Machine Learn- ing*. PMLR, 2018, pp. 5286-5295.

[39] Z. Wu, T. Nagarajan, A. Kumar, S. Rennie, L. S. Davis, K. Grauman, and R. Feris, "Blockdrop: Dynamic inference paths in residual networks," in *Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition*, 2018, pp. 8817-8826.
...
[41] K. Y. Xiao, V. Tjeng, N. M. Shafiullah, and A. Madry, "Training for faster adversarial robustness verification via inducing relu stability," *arXiv preprint arXiv:1809.03008*, 2018.

[42] K. Xu, Z. Shi, H. Zhang, Y. Wang, K.-W. Chang, M. Huang, B. Kailkhura, X. Lin, and C.-J. Hsieh, "Auto- matic perturbation analysis for scalable certified robustness and beyond," *Advances in Neural Information Processing Systems*, vol. 33, 2020.

[43] K. Xu, H. Zhang, S. Wang, Y. Wang, S. Jana, X. Lin, and C.-J. Hsieh, "Fast and complete: Enabling complete neural network verification with rapid and massively parallel incomplete verifiers," *arXiv preprint arXiv:2011.13824*, 2020.
...
[46] H. Zhang, T.-W. Weng, P.-Y. Chen, C.-J. Hsieh, and L. Daniel, "Efficient neural network robustness certifi- cation with general activation functions," *arXiv preprint arXiv:1811.00866*, 2018.

[47] T. Zhang, S. Ye, K. Zhang, J. Tang, W. Wen, M. Fardad, and Y. Wang, "A systematic dnn weight pruning frame- work using alternating direction method of multipliers," in *Proceedings of the European Conference on Computer Vision (ECCV)*, 2018, pp. 184-199.
...
[1] Gordon J Sutton, Jie Zeng, Ren Ping Liu, Wei Ni, Diep N Nguyen, Beeshanga A Jayawickrama, Xiaojing Huang, Mehran Abolhasan, Zhang Zhang, Eryk Dutkiewicz, et al. Enabling technolo- gies for ultra-reliable and low latency communications: From phy and mac layer perspectives. *IEEE Communications Surveys & Tutorials*, 21(3):2488–2524, 2019.

[2] Cheuk Ting Leung, Rajshekhar V Bhat, and Mehul Motani. Low-latency neural decoders for linear and non-linear block codes. In *2019 IEEE Global Communications Conference (GLOBECOM)*, pages 1–6. IEEE, 2019.

[3] Cheuk Ting Leung, Mehul Motani, and Rajshekhar V Bhat. Multi-label and concatenated neural block decoders. In *2020 IEEE International Symposium on Information Theory (ISIT)*, pages 274–279. IEEE, 2020.

[4] Cheuk Ting Leung, Rajshekhar V Bhat, and Mehul Motani. Multi-label neural decoders for block codes. In *ICC 2020-2020 IEEE International Conference on Communications (ICC)*, pages 1–6. IEEE, 2020.
...
[7] David Chase. Class of algorithms for decoding block codes with channel measurement informa- tion. *IEEE Transactions on Information theory*, 18(1):170–182, 1972.

[8] Hsin-Kun Lai and Erl-Huei Lu. Semi-soft decision decoding based on correspondence between error patterns and the relative test patterns. In *Second International Conference on Innovative Computing, Informatio and Control (ICICIC 2007)*, pages 396–396. IEEE, 2007.

[9] Shu Lin and Daniel J Costello. *Error control coding*, volume 2. Prentice hall Scarborough, 2001.

[10] Erdal Arikan. Channel polarization: A method for constructing capacity-achieving codes for symmetric binary-input memoryless channels. *IEEE Transactions on information Theory*, 55(7):3051–3073, 2009.